...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { name: @competition.name, submission_end_date: @competition.submission_end_date, vote_end_date: @competition.vote_end_date, winner: @competition.winner }
    end
  ...
  test "should update competition" do
    put :update, id: @competition, competition: { name: @competition.name, submission_end_date: @competition.submission_end_date, vote_end_date: @competition.vote_end_date, winner: @competition.winner }
    assert_redirected_to competition_path(assigns(:competition))
  end
